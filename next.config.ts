...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/cardistry", destination: "/kartentricks/cardistry", permanent: true },
      { source: "/fingerfertigkeit", destination: "/kartentricks/fingerfertigkeit", permanent: true },
      { source: "/zaubertricks/zaubersprueche", destination: "/zaubersprueche", permanent: true },
      { source: "/kartentricks/zaubersprueche", destination: "/zaubersprueche", permanent: true },
      { source: "/zaubersprüche", destination: "/zaubersprueche", permanent: true },
      { source: "/zauberspr%C3%BCche", destination: "/zaubersprueche", permanent: true },
