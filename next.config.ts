...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/category/handgriffe", destination: "/techniken", permanent: true },
      { source: "/category/handgriffe/:path*", destination: "/techniken", permanent: true },
      ...
      { source: "/technik-top-3-forces", destination: "/techniken/forces", permanent: true },
      { source: "/misdirection", destination: "/techniken/misdirection", permanent: true },
      ...
      { source: "/technik-pinky-break", destination: "/techniken/pinky-break", permanent: true },
      ...
      { source: "/double-lift", destination: "/techniken/double-lift", permanent: true },
      ...
      { source: "/karten-mischen-6-einfache-methoden", destination: "/techniken/karten-mischen", permanent: true },
      ...
      { source: "/zaubern-lernen-misdirection", destination: "/techniken/misdirection", permanent: true },
