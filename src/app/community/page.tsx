...
export default function CommunityPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <h1 className="text-[36px] font-medium text-slate-800 mb-4 font-[family-name:var(--font-inter)] leading-[1.2]">Community & Discord</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <div className="bg-[#1A1B26] text-white rounded-[16px] p-8 text-center">
          ...
          <h2 className="text-xl font-medium mb-2 font-[family-name:var(--font-inter)]">Discord Server</h2>
          ...
          <a
            ...
            className="inline-block bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium px-8 py-3 rounded-[8px] transition-colors text-sm font-[family-name:var(--font-inter)]"
          >
            Discord beitreten →
          </a>
        </div>
        ...
        <div className="bg-[#F5F3FF] border border-[#C4B5FD] rounded-[16px] p-8 text-center">
          ...
          <h2 className="text-xl font-medium text-[#4C1D95] mb-2 font-[family-name:var(--font-inter)]">Newsletter</h2>
          ...
          <Link
            href="#newsletter"
            className="inline-block bg-[#7C3AED] hover:bg-[#6D28D9] text-white font-medium px-8 py-3 rounded-[8px] transition-colors text-sm font-[family-name:var(--font-inter)]"
          >
            Jetzt anmelden →
          </Link>
        </div>
