      ...
      <div className="rounded-2xl bg-white p-8 text-center max-w-lg mx-auto mb-12 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
        ...
        <p className="text-slate-500 text-sm mb-6 leading-relaxed">
          ...
          <a
            ...
            className="group inline-flex items-center gap-2 rounded-full bg-slate-50 px-8 py-3 text-sm font-medium text-slate-800 transition-colors hover:bg-slate-100"
          >
            Discord beitreten
