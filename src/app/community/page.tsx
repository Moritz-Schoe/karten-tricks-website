...
export default function CommunityPage() {
  return (
    <div className="layout-page py-12">
      ...
      <div className="glass-card-elevated rounded-3xl p-8 text-center max-w-lg mx-auto mb-12">
        <div className="w-16 h-16 bg-[#5865F2]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
        ...
        <h2 className="text-xl font-medium text-slate-800 mb-2">Discord Server</h2>
        <p className="text-slate-500 text-sm mb-6 leading-relaxed">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-3 text-sm font-medium text-slate-800 transition-colors hover:bg-slate-50"
          >
            Discord beitreten <ArrowRight className="inline h-4 w-4" />
          </a>
      </div>
      </div>
    </div>
