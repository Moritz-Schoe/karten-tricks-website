  ...
  return (
    <div className="layout-page py-24">
      ...
      <div className="flex gap-3 justify-center">
        <Link
          href="/"
          className="bg-[#7C3AED] text-white font-medium px-6 py-3 rounded-[8px] hover:bg-[#6D28D9] transition-colors text-sm"
        >
          Zur Startseite
        </Link>
        <Link
          href="/kartentricks"
          className="border-[1.5px] border-[#7C3AED] text-[#7C3AED] font-medium px-6 py-3 rounded-[8px] hover:bg-[#F5F3FF] transition-colors text-sm"
        >
          Tricks entdecken
        </Link>
      </div>
