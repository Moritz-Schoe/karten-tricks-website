  ...
  return (
    <div className="layout-page py-12">
      ...
      <nav className="text-sm text-neutral-400 mb-8">
        ...
        <span className="text-neutral-600">Über mich</span>
      </nav>
      ...
      <div className="rounded-2xl bg-white p-6 sm:p-8 flex items-start gap-6 mb-10 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-neutral-800 mb-1">Moritz</h1>
          <p className="text-neutral-500">Gründer von karten-tricks.de · Kartentrick-Enthusiast seit 2014</p>
          <div className="flex flex-wrap gap-2 mt-3">
            ...
            <span className="text-xs bg-primary/10 text-primary px-3 py-1 rounded-full font-medium">Community</span>
          </div>
        </div>
      </div>
        ...
        <section className="rounded-2xl bg-white p-8 text-center shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          ...
          <p className="text-neutral-500 mb-6 max-w-md mx-auto text-sm leading-relaxed">
            ...
            <a
              ...
              className="inline-flex h-[44px] items-center gap-2 rounded-full bg-white px-8 text-sm font-medium text-neutral-800 transition-colors hover:bg-neutral-50"
            >
