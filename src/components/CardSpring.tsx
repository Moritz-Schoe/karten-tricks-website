...
function CardFace({
  ...
  const suitColor = dark ? "#1A1B26" : "#6F8AB7";
    ...
    return (
      ...
      >
        ...
        <rect
          ...
          fill="none" stroke="#6F8AB7" strokeWidth="1.5" opacity="0.55"
        />
        {/* Diagonal cross */}
        <line x1="6" y1="6" x2="74" y2="106" stroke="#6F8AB7" strokeWidth="0.7" opacity="0.22" />
        <line x1="74" y1="6" x2="6" y2="106" stroke="#6F8AB7" strokeWidth="0.7" opacity="0.22" />
        {/* Centre diamond */}
        <polygon
          points="40,44 56,56 40,68 24,56"
          fill="none" stroke="#6F8AB7" strokeWidth="1.5" opacity="0.65"
        />
        <polygon
          points="40,50 49,56 40,62 31,56"
          fill="#6F8AB7" opacity="0.35"
        />
      </svg>
    );
  }
